...
<form class="login100-form validate-form p-b-33 p-t-5" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
	...
	<div class="wrap-input100 validate-input <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>" data-validate="Confirm password">
	...
	<p class="p_p">Already have an account? <a href="login.php">Login here</a>.</p>
</form>
</div>
</div>
</div>
